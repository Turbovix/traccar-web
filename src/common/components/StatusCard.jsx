...
const useStyles = makeStyles()((theme, { desktopPadding }) => ({
  card: {
    ...
    overflow: 'visible', // ← corrige recorte do botão X na borda do card
  },
  media: {
  ...
  root: {
    ...
    [theme.breakpoints.up('md')]: {
      ...
      zIndex: 5,           // ← corrigido: era 3, conflitava com zIndex: 5 do nível base
      overflow: 'visible', // ← corrige recorte do botão X quando popup está no topo
    },
    [theme.breakpoints.down('md')]: {
      ...
      overflow: 'visible', // ← idem para mobile
    },
